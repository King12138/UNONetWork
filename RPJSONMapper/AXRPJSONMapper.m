...
+ (instancetype)sharedInstance {
    ...
    static AXRPJSONMapper *sharedInstance;
    dispatch_once(&once, ^{
...
- (AXRPBoxSpecification *)boxValueAsNSStringIntoPropertyWithName:(NSString *)propertyName {
    return [AXRPBoxSpecification boxValueIntoPropertyWithName:propertyName
...
- (AXRPBoxSpecification *)boxValueAsNSNumberIntoPropertyWithName:(NSString *)propertyName {
    __block __weak AXRPJSONMapper *blockSafeSelf = self;

    return [AXRPBoxSpecification boxValueIntoPropertyWithName:propertyName
                                                 usingBlock:^id(id jsonValue) {
                                                     if([jsonValue isKindOfClass:[NSString class]]) {
                                                         NSNumber *number;
                                                         if ([jsonValue isEqualToString:@"false"]) {
                                                             jsonValue = @"0";
                                                         }
...
- (AXRPBoxSpecification *)boxValueAsNSDateIntoPropertyWithName:(NSString *)propertyName
...
#pragma mark mark - Debug Logging
...
#pragma mark mark - Private Methods
...
- (void)mapJSONValue:(id)jsonValue
    ...
    } else if([mapping isKindOfClass:[AXRPBoxSpecification class]]) {
...
- (void)mapJSONValue:(id)jsonValue
withBoxSpecification:(AXRPBoxSpecification *)boxSpecification
          toInstance:(id)instance {
...
#pragma mark mark - Private Auto Boxing Methods
...
#pragma mark clang diagnostic ignored "-Warc-performSelector-leaks"
    AXRPBoxSpecification *boxSpecification = [self performSelector:setSelector withObject:propertyName];
